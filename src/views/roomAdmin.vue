...
import RoomAdmin from "../components/reservation/RoomAdmin.vue"
...
export default {
  components: {Foot, Aside, RoomAdmin, Header},
  data() {
    return {
      text: '',
      textarea: '',
  ...
  methods: {
    // 处理自定义事件，更新 selectedMenuItem
    handleMenuSelected(index) {
      this.selectedMenuItem = index;
    },
  },
  watch: {
    // 监听 selectedMenuItem 的变化
    selectedMenuItem(newValue) {
      // 在这里你可以根据实际需求进行其他操作
      console.log("Selected Menu Item:", newValue);
    },
  },
}
</script>
